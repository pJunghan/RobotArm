...
#include "team4_msgs/msg/detail/storagy_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.storagy_status;
  // Member: seat_number
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = team4_msgs::msg::StoragyStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const team4_msgs::msg::StoragyStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<team4_msgs::msg::StoragyStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _StoragyStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const team4_msgs::msg::StoragyStatus *>(
...
static size_t _StoragyStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_StoragyStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _StoragyStatus__callbacks = {
  "team4_msgs::msg",
  "StoragyStatus",
...
static rosidl_message_type_support_t _StoragyStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_StoragyStatus__callbacks,
...
{
  return &team4_msgs::msg::typesupport_fastrtps_cpp::_StoragyStatus__handle;
}
