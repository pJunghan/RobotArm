...
team4_msgs__msg__ArisStatus__init(team4_msgs__msg__ArisStatus * msg)
{
  ...
  // aris_status
  if (!rosidl_runtime_c__String__init(&msg->aris_status)) {
    team4_msgs__msg__ArisStatus__fini(msg);
    return false;
  }
  // seat_number
  return true;
...
team4_msgs__msg__ArisStatus__fini(team4_msgs__msg__ArisStatus * msg)
{
  ...
  // aris_status
  rosidl_runtime_c__String__fini(&msg->aris_status);
  // seat_number
}
...
team4_msgs__msg__ArisStatus__are_equal(const team4_msgs__msg__ArisStatus * lhs, const team4_msgs__msg__ArisStatus * rhs)
{
  ...
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->aris_status), &(rhs->aris_status)))
  {
    return false;
  }
  // seat_number
  ...
  team4_msgs__msg__ArisStatus * output)
{
  ...
  if (!rosidl_runtime_c__String__copy(
      &(input->aris_status), &(output->aris_status)))
  {
    return false;
  }
  // seat_number
...
team4_msgs__msg__ArisStatus__create()
{
  ...
  team4_msgs__msg__ArisStatus * msg = (team4_msgs__msg__ArisStatus *)allocator.allocate(sizeof(team4_msgs__msg__ArisStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(team4_msgs__msg__ArisStatus));
  bool success = team4_msgs__msg__ArisStatus__init(msg);
  if (!success) {
...
team4_msgs__msg__ArisStatus__Sequence__init(team4_msgs__msg__ArisStatus__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  team4_msgs__msg__ArisStatus * data = NULL;

  if (size) {
    data = (team4_msgs__msg__ArisStatus *)allocator.zero_allocate(size, sizeof(team4_msgs__msg__ArisStatus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = team4_msgs__msg__ArisStatus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        team4_msgs__msg__ArisStatus__fini(&data[i - 1]);
      }
...
team4_msgs__msg__ArisStatus__Sequence__fini(team4_msgs__msg__ArisStatus__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      team4_msgs__msg__ArisStatus__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  team4_msgs__msg__ArisStatus__Sequence * array = (team4_msgs__msg__ArisStatus__Sequence *)allocator.allocate(sizeof(team4_msgs__msg__ArisStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = team4_msgs__msg__ArisStatus__Sequence__init(array, size);
  if (!success) {
...
team4_msgs__msg__ArisStatus__Sequence__destroy(team4_msgs__msg__ArisStatus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    team4_msgs__msg__ArisStatus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
team4_msgs__msg__ArisStatus__Sequence__are_equal(const team4_msgs__msg__ArisStatus__Sequence * lhs, const team4_msgs__msg__ArisStatus__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!team4_msgs__msg__ArisStatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  team4_msgs__msg__ArisStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(team4_msgs__msg__ArisStatus);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    team4_msgs__msg__ArisStatus * data =
      (team4_msgs__msg__ArisStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!team4_msgs__msg__ArisStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          team4_msgs__msg__ArisStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!team4_msgs__msg__ArisStatus__copy(
