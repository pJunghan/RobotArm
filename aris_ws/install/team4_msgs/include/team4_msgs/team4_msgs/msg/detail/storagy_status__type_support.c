...
static rosidl_typesupport_introspection_c__MessageMember team4_msgs__msg__StoragyStatus__rosidl_typesupport_introspection_c__StoragyStatus_message_member_array[2] = {
  {
    "storagy_status",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(team4_msgs__msg__StoragyStatus, seat_number),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
