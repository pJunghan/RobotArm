...
class YOLOMain:
    ...
    def segmentation(self):
        ...
        while True:
            ...
            # 현재 프레임 예측
            boxes, masks, cls, probs = self.predict_on_image(frame, conf=0.85)
            ...
            # 거리 조건 체크 및 로봇 제어
            if min_distance <= 50 and min_distance_bool:
